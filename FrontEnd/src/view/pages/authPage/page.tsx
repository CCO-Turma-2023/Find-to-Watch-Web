    ...
    >
        <AnimatePresence initial={false}>
            ...
            <motion.div
                ...
                style={{
                background: "linear-gradient(to right, rgba(10,10,10,1) 0%, rgba(10,10,10,0.95) 60%, transparent 100%)"
                }}
            >
            ...
            <motion.div
                ...
                style={{
                background: "linear-gradient(to left, rgba(10,10,10,1) 0%, rgba(10,10,10,0.95) 60%, transparent 100%)"
                }}
            >
